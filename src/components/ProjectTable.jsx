...
export default function ProjectTable() {
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg animate-fadeInUp transition-transform duration-300 hover:scale-[1.01]">
                ...
                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-1">
                    <div
                      ...
                      style={{ width: `${project.completion}%` }} // Dynamic width for progress bar
                    ></div>
                  </div>
                </td>
              </tr>
