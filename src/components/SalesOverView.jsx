...
const SalesOverView = () => {
  return (
    <div className="flex justify-center items-center h-[150] bg-gray-50 p-4 font-inter   ">
      {/* Card-like container for the chart */}
      <div className="bg-white rounded-lg shadow-xl p-6 w-[90%] max-w-4xl  transition-transform duration-300 hover:scale-[1.1]">
        {/* Chart Header */}
        <div className="mb-6">
